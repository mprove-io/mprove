...
const userId = '23-04-user@example.com';
const password = '123123';

const projectId = 'project_23_04';

describe('23-04 model-filters-ts-type-is-before-relative-incomplete-in-future (logged in)', () => {
  it(`should be able to filter ts-type-is-before-relative-incomplete-in-future`, () => {
    cy.deletePack({
      user_ids: [userId],
