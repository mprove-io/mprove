...
const userId = '23-09-user@example.com';
const password = '123123';

const projectId = 'project_23_09';

describe('23-09 model-filters-ts-type-is-before-relative-complete-in-future-for-minutes (logged in)', () => {
  it(`should be able to filter ts-type-is-before-relative-complete-in-future-for-minutes`, () => {
    cy.deletePack({
      user_ids: [userId],
