...
const userId = '20-03-user@example.com';
const password = '123123';

const projectId = 'project_20_03';

describe('20-03 model-filters-ts-type-is-before-date (logged in)', () => {
  it(`should be able to filter ts-type-is-before-date`, () => {
    cy.deletePack({
      user_ids: [userId],
