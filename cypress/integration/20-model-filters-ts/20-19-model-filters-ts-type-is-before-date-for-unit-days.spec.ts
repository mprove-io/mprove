...
const userId = '20-19-user@example.com';
const password = '123123';

const projectId = 'project_20_19';

describe('20-19 model-filters-ts-type-is-before-date-for-unit-days (logged in)', () => {
  it(`should be able to filter ts-type-is-before-date-for-unit-days`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionTsForUnitDays]').click();
    cy.loading();
