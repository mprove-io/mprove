...
const userId = '20-05-user@example.com';
const password = '123123';

const projectId = 'project_20_05';

describe('20-05 model-filters-ts-type-is-before-relative (logged in)', () => {
  it(`should be able to filter ts-type-is-before-relative`, () => {
    cy.deletePack({
      user_ids: [userId],
