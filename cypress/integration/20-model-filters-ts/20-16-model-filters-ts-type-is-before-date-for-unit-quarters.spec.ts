...
const userId = '20-16-user@example.com';
const password = '123123';

const projectId = 'project_20_16';

describe('20-16 model-filters-ts-type-is-before-date-for-unit-quarters (logged in)', () => {
  it(`should be able to filter ts-type-is-before-date-for-unit-quarters`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionTsForUnitQuarters]').click();
    cy.loading();
