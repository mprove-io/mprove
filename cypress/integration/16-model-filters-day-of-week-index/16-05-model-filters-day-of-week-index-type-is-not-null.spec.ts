...
const userId = '16-05-user@example.com';
const password = '123123';

const projectId = 'project_16_05';

describe('16-05 model-filters-day-of-week-index-type-is-not-null (logged in)', () => {
  it(`should be able to filter day-of-week-index-type-is-not-null`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionDayOfWeekIndexTypeIsNotNull]').click();
