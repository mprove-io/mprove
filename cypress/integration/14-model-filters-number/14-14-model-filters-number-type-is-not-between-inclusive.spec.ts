...
const userId = '14-14-user@example.com';
const password = '123123';

const projectId = 'project_14_14';

describe('14-14 model-filters-number-type-is-not-between-inclusive (logged in)', () => {
  it(`should be able to filter number-type-is-not-between-inclusive`, () => {
    cy.deletePack({
      user_ids: [userId],
