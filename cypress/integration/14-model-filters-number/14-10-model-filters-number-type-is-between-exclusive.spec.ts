...
const userId = '14-10-user@example.com';
const password = '123123';

const projectId = 'project_14_10';

describe('14-10 model-filters-number-type-is-between-exclusive (logged in)', () => {
  it(`should be able to filter number-type-is-between-exclusive`, () => {
    cy.deletePack({
      user_ids: [userId],
