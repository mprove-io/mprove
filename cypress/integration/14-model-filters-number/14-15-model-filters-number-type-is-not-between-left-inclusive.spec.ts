...
const userId = '14-15-user@example.com';
const password = '123123';

const projectId = 'project_14_15';

describe('14-15 model-filters-number-type-is-not-between-left-inclusive (logged in)', () => {
  it(`should be able to filter number-type-is-not-between-left-inclusive`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionNumberBetweenOptionLeftInclusive]').click();
