...
const userId = '14-09-user@example.com';
const password = '123123';

const projectId = 'project_14_09';

describe('14-09 model-filters-number-type-is-between-right-inclusive (logged in)', () => {
  it(`should be able to filter number-type-is-between-right-inclusive`, () => {
    cy.deletePack({
      user_ids: [userId],
