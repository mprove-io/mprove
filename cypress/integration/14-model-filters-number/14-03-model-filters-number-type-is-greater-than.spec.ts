...
const userId = '14-03-user@example.com';
const password = '123123';

const projectId = 'project_14_03';

describe('14-03 model-filters-number-type-is-greater-than (logged in)', () => {
  it(`should be able to filter number-type-is-greater-than`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionNumberTypeIsGreaterThan]').click();
