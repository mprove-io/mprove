...
const userId = '14-08-user@example.com';
const password = '123123';

const projectId = 'project_14_08';

describe('14-08 model-filters-number-type-is-between-left-inclusive (logged in)', () => {
  it(`should be able to filter number-type-is-between-left-inclusive`, () => {
    cy.deletePack({
      user_ids: [userId],
