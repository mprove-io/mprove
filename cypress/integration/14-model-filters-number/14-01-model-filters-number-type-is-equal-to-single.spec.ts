...
const userId = '14-01-user@example.com';
const password = '123123';

const projectId = 'project_14_01';

describe('14-01 model-filters-number-type-is-equal-to-single (logged in)', () => {
  it(`should be able to filter number-type-is-equal-to-single`, () => {
    cy.deletePack({
      user_ids: [userId],
