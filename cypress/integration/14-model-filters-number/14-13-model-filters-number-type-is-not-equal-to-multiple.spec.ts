...
const userId = '14-13-user@example.com';
const password = '123123';

const projectId = 'project_14_13';

describe('14-13 model-filters-number-type-is-not-equal-to-multiple (logged in)', () => {
  it(`should be able to filter number-type-is-not-equal-to-multiple`, () => {
    cy.deletePack({
      user_ids: [userId],
