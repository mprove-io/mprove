...
const userId = '14-05-user@example.com';
const password = '123123';

const projectId = 'project_14_05';

describe('14-05 model-filters-number-type-is-less-than (logged in)', () => {
  it(`should be able to filter number-type-is-less-than`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionNumberTypeIsLessThan]').click();
