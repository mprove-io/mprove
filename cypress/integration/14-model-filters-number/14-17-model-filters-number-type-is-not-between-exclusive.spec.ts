...
const userId = '14-17-user@example.com';
const password = '123123';

const projectId = 'project_14_17';

describe('14-17 model-filters-number-type-is-not-between-exclusive (logged in)', () => {
  it(`should be able to filter number-type-is-not-between-exclusive`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionNumberBetweenOptionExclusive]').click();
