...
const userId = '13-04-user@example.com';
const password = '123123';

const projectId = 'project_13_04';

describe('13-04 model-filters-string-type-ends-with (logged in)', () => {
  it(`should be able to filter string-type-ends-with`, () => {
    cy.deletePack({
      user_ids: [userId],
