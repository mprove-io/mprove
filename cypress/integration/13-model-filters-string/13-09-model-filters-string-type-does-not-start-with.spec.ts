...
const userId = '13-09-user@example.com';
const password = '123123';

const projectId = 'project_13_09';

describe('13-09 model-filters-string-type-does-not-start-with (logged in)', () => {
  it(`should be able to filter string-type-does-not-start-with`, () => {
    cy.deletePack({
      user_ids: [userId],
