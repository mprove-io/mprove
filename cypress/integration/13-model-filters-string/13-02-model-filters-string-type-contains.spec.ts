...
const userId = '13-02-user@example.com';
const password = '123123';

const projectId = 'project_13_02';

describe('13-02 model-filters-string-type-contains (logged in)', () => {
  it(`should be able to filter string-type-contains`, () => {
    cy.deletePack({
      user_ids: [userId],
