...
//       if (
//         chartTypesXField.indexOf(report.type) > -1 &&
//         (typeof report.data === 'undefined' ||
//           report.data === null ||
//           typeof report.data.x_field === 'undefined' ||
//           report.data.x_field === null)
//       ) {
//         // error e176
//         ErrorsCollector.addError(
//           new AmError({
//             title: `missing 'x_field'`,
//             message: `report of type "${
//               report.type
//             }" must have 'x_field' parameter in data`,
//             lines: [
//               {
...
//       if (
//         chartTypesYField.indexOf(report.type) > -1 &&
//         (typeof report.data === 'undefined' ||
//           report.data === null ||
//           typeof report.data.y_field === 'undefined' ||
//           report.data.y_field === null)
//       ) {
//         // error e177
//         ErrorsCollector.addError(
//           new AmError({
...
//             message: `report of type "${
//               report.type
//             }" must have 'y_field' parameter in data`,
//             lines: [
//               {
//                 line: report.data_line_num,
//                 name: x.file,
...
//       if (
//         chartTypesYFields.indexOf(report.type) > -1 &&
//         (typeof report.data === 'undefined' ||
//           report.data === null ||
//           typeof report.data.y_fields === 'undefined' ||
//           report.data.y_fields === null)
//       ) {
//         // error e206
//         ErrorsCollector.addError(
//           new AmError({
...
//             message: `report of type "${
//               report.type
//             }" must have 'y_fields' parameter in data`,
//             lines: [
//               {
//                 line: report.data_line_num,
//                 name: x.file,
...
//         (typeof report.data === 'undefined' ||
//           report.data === null ||
//           typeof report.data.value_field === 'undefined' ||
//           report.data.value_field === null)
//       ) {
//         // error e178
//         ErrorsCollector.addError(
//           new AmError({
...
//             message: `report of type "${
//               report.type
//             }" must have 'value_field' parameter in data`,
//             lines: [
//               {
//                 line: report.data_line_num,
//                 name: x.file,
...
//         if (
//           typeof report.data.multi_field !== 'undefined' &&
//           report.data.multi_field !== null &&
...
//         if (
//           typeof report.data.previous_value_field !== 'undefined' &&
//           report.data.previous_value_field !== null &&
...
//         if (
//           typeof report.data.hide_columns !== 'undefined' &&
//           report.data.hide_columns !== null
//         ) {
