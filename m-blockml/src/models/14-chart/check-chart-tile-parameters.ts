...
// export function checkChartTileParameters(item: {
...
//           if (
//             !!(<any>report.tile)[parameter] &&
//             (<any>report.tile)[parameter].constructor === Object
//           ) {
//             // error e201
//             ErrorsCollector.addError(
//               new AmError({
...
//                 message: `"${
//                   report.tile[parameter]
//                 }" is not valid tile_height value`,
//                 lines: [
//                   {
//                     line: (<any>report.tile)[parameter + '_line_num'],
//                     name: x.file,
...
//           if (
//             ['view_width', 'view_height'].indexOf(parameter) > -1 &&
//             !(<any>report.tile)[parameter].match(
