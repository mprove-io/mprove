...
//           if (
//             !!(<any>report.options)[parameter] &&
//             (<any>report.options)[parameter].constructor === Object
//           ) {
//             // error e190
//             ErrorsCollector.addError(
//               new AmError({
...
//                 }" is not valid interpolation value`,
//                 lines: [
//                   {
//                     line: (<any>report.options)[parameter + '_line_num'],
//                     name: x.file,
...
//                 message: `"${
//                   report.options[parameter]
//                 }" is not valid color_scheme value`,
//                 lines: [
//                   {
//                     line: (<any>report.options)[parameter + '_line_num'],
//                     name: x.file,
...
//                 message: `"${
//                   report.options[parameter]
//                 }" is not valid scheme_type value`,
//                 lines: [
//                   {
//                     line: (<any>report.options)[parameter + '_line_num'],
//                     name: x.file,
...
//               'max'
//             ].indexOf(parameter) > -1 &&
//             !(<any>report.options)[parameter].match(
//               ApRegex.CAPTURE_DIGITS_START_TO_END_G()
//             )
//           ) {
//             // error e194
//             ErrorsCollector.addError(
...
//           if (
//             ['arc_width', 'range_fill_opacity'].indexOf(parameter) > -1 &&
//             !(<any>report.options)[parameter].match(
//               ApRegex.CAPTURE_FLOAT_START_TO_END_G()
//             )
//           ) {
//             // error e195
//             ErrorsCollector.addError(
...
//             ].indexOf(parameter) > -1 &&
//             !(<any>report.options)[parameter].match(
//               ApRegex.CAPTURE_MINUS_DIGITS_START_TO_END_G()
//             )
//           ) {
//             // error e197
//             ErrorsCollector.addError(
...
//           if (
//             ['band_color', 'card_color', 'text_color', 'empty_color'].indexOf(
//               parameter
//             ) > -1 &&
