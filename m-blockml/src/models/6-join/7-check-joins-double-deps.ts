            ...
            if (depField.fieldClass === enums.FieldClassEnum.Filter) {
              item.errors.push(
                new BmError({
                  ...
                  message:
                    `"${enums.ParameterEnum.SqlOn}" can\'t reference filters. ` +
            ...
            if (depField.fieldClass === enums.FieldClassEnum.Measure) {
              item.errors.push(
                new BmError({
                  ...
                  message:
                    `"${enums.ParameterEnum.SqlOn}" can\'t reference measures. ` +
            ...
            if (depField.fieldClass === enums.FieldClassEnum.Calculation) {
              item.errors.push(
                new BmError({
                  ...
                  message:
                    `"${enums.ParameterEnum.SqlOn}" can\'t reference calculations. ` +
