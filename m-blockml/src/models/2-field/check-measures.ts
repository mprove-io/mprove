...
//             message: `parameter "sql_key:" is required for measure of ${
//               field.type
//             } type`,
//             lines: [
//               {
...
//               message: `parameter "percentile" is required for measure of type ${
//                 field.type
//               }`,
//               lines: [
//                 {
...
//       if (
//         field.sql_key &&
//         !field.sql_key.match(ApRegex.CONTAINS_BLOCKML_REF())
//       ) {
//         // error e278
//         ErrorsCollector.addError(
//           new AmError({
