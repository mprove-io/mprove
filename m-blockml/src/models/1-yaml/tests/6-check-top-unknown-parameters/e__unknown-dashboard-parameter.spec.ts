...
let pack = '1-yaml';
let funcId = '6-check-top-unknown-parameters';
let testId = 'e__unknown-dashboard-parameter';
...
test(testId, async () => {
  ...
  expect(errors[0].title).toBe(enums.ErTitleEnum.UNKNOWN_DASHBOARD_PARAMETER);
});
