...
//                   message:
//                     `Listener "${part}" is not valid. Listeners must be in form "alias_name.field_name" ` +
...
//               if (
//                 typeof report.listen[listener] !== 'undefined' &&
//                 report.listen[listener] !== null
//               ) {
//                 // error e94
//                 ErrorsCollector.addError(
//                   new AmError({
...
//                     message:
//                       `"${filterName}" filter result "${
//                         dashboardField.result
//                       }" does not match ` +
...
//                     message:
//                       `found listener "${listener}" references missing or not valid field ` +
