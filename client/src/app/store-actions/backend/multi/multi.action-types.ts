...
export const DUPLICATE_MCONFIG_AND_QUERY = ngrxType(
  'DUPLICATE_MCONFIG_AND_QUERY'
);
export const DUPLICATE_MCONFIG_AND_QUERY_SUCCESS = ngrxType(
  'DUPLICATE_MCONFIG_AND_QUERY_SUCCESS'
);
export const DUPLICATE_MCONFIG_AND_QUERY_FAIL = ngrxType(
  'DUPLICATE_MCONFIG_AND_QUERY_FAIL'
);
