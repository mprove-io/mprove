...
export const SET_PROJECT_CONNECTION = ngrxType('SET_PROJECT_CONNECTION');
export const SET_PROJECT_CONNECTION_SUCCESS = ngrxType(
  'SET_PROJECT_CONNECTION_SUCCESS'
);
export const SET_PROJECT_CONNECTION_FAIL = ngrxType(
  'SET_PROJECT_CONNECTION_FAIL'
);
