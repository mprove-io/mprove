...
const userId = '23-03-user@example.com';
const password = '123123';

const projectId = 'project_23_03';

describe('23-03 model-filters-ts-type-is-before-relative-incomplete (logged in)', () => {
  it(`should be able to filter ts-type-is-before-relative-incomplete`, () => {
    cy.deletePack({
      user_ids: [userId],
