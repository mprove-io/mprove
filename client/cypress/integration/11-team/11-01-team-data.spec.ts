...
const userId = '11-01-user@example.com';
const password = '123123';

const projectId = 'project_11_01';

describe('11-01 team-data (logged in)', () => {
  it(`should see data`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=teamMemberAliasData]').should('contain', '11-01-user');
