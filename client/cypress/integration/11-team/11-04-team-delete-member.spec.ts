...
const userId = '11-04-user-a@example.com';
const secondUserId = '11-04-user-b@example.com';
const password = '123123';

const projectId = 'project_11_04';

describe('11-04 team-delete-member (logged in)', () => {
