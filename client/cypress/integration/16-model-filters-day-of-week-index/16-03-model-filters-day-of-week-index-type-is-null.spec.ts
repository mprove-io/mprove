...
const userId = '16-03-user@example.com';
const password = '123123';

const projectId = 'project_16_03';

describe('16-03 model-filters-day-of-week-index-type-is-equal-to-null (logged in)', () => {
  it(`should be able to filter day-of-week-index-type-is-equal-to-null`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionDayOfWeekIndexTypeIsNull]').click();
