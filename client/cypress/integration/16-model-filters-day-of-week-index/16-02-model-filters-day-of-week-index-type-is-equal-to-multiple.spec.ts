...
const userId = '16-02-user@example.com';
const password = '123123';

const projectId = 'project_16_02';

describe('16-02 model-filters-day-of-week-index-type-is-equal-to-multiple (logged in)', () => {
  it(`should be able to filter day-of-week-index-type-is-equal-to-multiple`, () => {
    cy.deletePack({
      user_ids: [userId],
