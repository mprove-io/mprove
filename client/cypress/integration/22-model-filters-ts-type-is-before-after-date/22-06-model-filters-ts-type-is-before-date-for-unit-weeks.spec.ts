...
const userId = '22-06-user@example.com';
const password = '123123';

const projectId = 'project_22_06';

describe('22-06 model-filters-ts-type-is-before-date-for-unit-weeks (logged in)', () => {
  it(`should be able to filter ts-type-is-before-date-for-unit-weeks`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionTsForUnitWeeks]').click();
    cy.loading();
