...
const userId = '22-02-user@example.com';
const password = '123123';

const projectId = 'project_22_02';

describe('22-02 model-filters-ts-type-is-before-date-for-infinity (logged in)', () => {
  it(`should be able to filter ts-type-is-before-date-for-infinity`, () => {
    cy.deletePack({
      user_ids: [userId],
