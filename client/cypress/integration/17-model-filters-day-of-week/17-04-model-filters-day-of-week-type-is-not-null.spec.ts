...
const userId = '17-04-user@example.com';
const password = '123123';

const projectId = 'project_17_04';

describe('17-04 model-filters-day-of-week-type-is-not-null (logged in)', () => {
  it(`should be able to filter day-of-week-type-is-not-null`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionDayOfWeekTypeIsNotNull]').click();
    cy.loading();
