...
const userId = '17-02-user@example.com';
const password = '123123';

const projectId = 'project_17_02';

describe('17-02 model-filters-day-of-week-type-is-null (logged in)', () => {
  it(`should be able to filter day-of-week-type-is-null`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionDayOfWeekTypeIsNull]').click();
    cy.loading();
