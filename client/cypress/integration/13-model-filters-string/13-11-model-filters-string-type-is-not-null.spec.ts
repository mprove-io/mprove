...
const userId = '13-11-user@example.com';
const password = '123123';

const projectId = 'project_13_11';

describe('13-11 model-filters-string-type-is-not-null (logged in)', () => {
  it(`should be able to filter string-type-is-not-null`, () => {
    cy.deletePack({
      user_ids: [userId],
