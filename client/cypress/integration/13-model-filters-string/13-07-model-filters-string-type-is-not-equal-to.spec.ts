...
const userId = '13-07-user@example.com';
const password = '123123';

const projectId = 'project_13_07';

describe('13-07 model-filters-string-type-is-not-equal-to (logged in)', () => {
  it(`should be able to filter string-type-is-not-equal-to`, () => {
    cy.deletePack({
      user_ids: [userId],
