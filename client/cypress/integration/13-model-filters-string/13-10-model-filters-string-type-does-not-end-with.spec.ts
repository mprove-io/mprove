...
const userId = '13-10-user@example.com';
const password = '123123';

const projectId = 'project_13_10';

describe('13-10 model-filters-string-type-does-not-end-with (logged in)', () => {
  it(`should be able to filter string-type-does-not-end-with`, () => {
    cy.deletePack({
      user_ids: [userId],
