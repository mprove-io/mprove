...
const userId = '13-08-user@example.com';
const password = '123123';

const projectId = 'project_13_08';

describe('13-08 model-filters-string-type-does-not-contain (logged in)', () => {
  it(`should be able to filter string-type-does-not-contain`, () => {
    cy.deletePack({
      user_ids: [userId],
