...
const userId = '13-05-user@example.com';
const password = '123123';

const projectId = 'project_13_05';

describe('13-05 model-filters-string-type-is-null (logged in)', () => {
  it(`should be able to filter string-type-is-null`, () => {
    cy.deletePack({
      user_ids: [userId],
