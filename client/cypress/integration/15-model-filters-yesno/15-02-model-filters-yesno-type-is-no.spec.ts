...
const userId = '15-02-user@example.com';
const password = '123123';

const projectId = 'project_15_02';

describe('15-02 model-filters-yesno-type-is-no (logged in)', () => {
  it(`should be able to filter yesno-type-is-no`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.loading();
    cy.get('[data-cy=fractionYesnoValue]').click();
    cy.get('[data-cy=fractionYesnoValueNo]').click();
    cy.loading();
