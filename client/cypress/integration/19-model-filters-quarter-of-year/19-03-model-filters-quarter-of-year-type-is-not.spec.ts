...
const userId = '19-03-user@example.com';
const password = '123123';

const projectId = 'project_19_03';

describe('19-03 model-filters-quarter-of-year-type-is-not (logged in)', () => {
  it(`should be able to filter quarter-of-year-type-is-not`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionQuarterOfYearTypeIsNot]').click();
    cy.loading();
