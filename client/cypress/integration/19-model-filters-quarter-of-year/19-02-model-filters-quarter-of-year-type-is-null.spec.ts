...
const userId = '19-02-user@example.com';
const password = '123123';

const projectId = 'project_19_02';

describe('19-02 model-filters-quarter-of-year-type-is-null (logged in)', () => {
  it(`should be able to filter quarter-of-year-type-is-null`, () => {
    cy.deletePack({
      user_ids: [userId],
