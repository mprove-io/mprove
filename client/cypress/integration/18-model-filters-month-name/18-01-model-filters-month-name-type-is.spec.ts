...
const userId = '18-01-user@example.com';
const password = '123123';

const projectId = 'project_18_01';

describe('18-01 model-filters-month-name-type-is (logged in)', () => {
  it(`should be able to filter month-name-type-is`, () => {
    cy.deletePack({
      user_ids: [userId],
