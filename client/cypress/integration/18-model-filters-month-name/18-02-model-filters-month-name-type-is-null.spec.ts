...
const userId = '18-02-user@example.com';
const password = '123123';

const projectId = 'project_18_02';

describe('18-02 model-filters-month-name-type-is-null (logged in)', () => {
  it(`should be able to filter month-name-type-is-null`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionMonthNameTypeIsNull]').click();
    cy.loading();
