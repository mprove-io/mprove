...
const userId = '14-11-user@example.com';
const password = '123123';

const projectId = 'project_14_11';

describe('14-11 model-filters-number-type-is-null (logged in)', () => {
  it(`should be able to filter number-type-is-null`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionNumberTypeIsNull]').click();
