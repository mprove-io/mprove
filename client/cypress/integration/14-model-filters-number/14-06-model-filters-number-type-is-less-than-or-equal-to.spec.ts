...
const userId = '14-06-user@example.com';
const password = '123123';

const projectId = 'project_14_06';

describe('14-06 model-filters-number-type-is-less-than-or-equal-to (logged in)', () => {
  it(`should be able to filter number-type-is-less-than-or-equal-to`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionNumberTypeIsLessThanOrEqualTo]').click();
