...
const userId = '14-16-user@example.com';
const password = '123123';

const projectId = 'project_14_16';

describe('14-16 model-filters-number-type-is-not-between-right-inclusive (logged in)', () => {
  it(`should be able to filter number-type-is-not-between-right-inclusive`, () => {
    cy.deletePack({
      user_ids: [userId],
    ...
    cy.get('[data-cy=fractionNumberTypeIsNotBetween]').click();
    cy.get('[data-cy=fractionNumberBetweenOption]').click();
    cy.get('[data-cy=fractionNumberBetweenOptionRightInclusive]').click();
