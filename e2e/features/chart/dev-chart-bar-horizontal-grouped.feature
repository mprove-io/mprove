Feature: dev-chart-bar-horizontal-grouped

  Scenario: dev-chart-bar-horizontal-grouped
    Given [common] scenario 'dev-chart-bar-horizontal-grouped'
    ...
    Then [common] I enter 'Bar Horizontal Grouped' into 'chartTitle' row '1'
    Then [common] I click field 'modelTitle' row '0'
    Then [common] Field 'chartTitle' row '1' attribute 'value' should be 'Bar Horizontal Grouped'        

    Then [common] I wait "1" seconds

    Then [common] I click field 'chartType' row '1'
    Then [common] I click field 'chartTypeBarHorizontalGrouped' row '0'
