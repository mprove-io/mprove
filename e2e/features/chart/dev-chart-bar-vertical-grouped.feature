Feature: dev-chart-bar-vertical-grouped

  Scenario: dev-chart-bar-vertical-grouped
    Given [common] scenario 'dev-chart-bar-vertical-grouped'
    ...
    Then [common] I enter 'Bar Vertical Grouped' into 'chartTitle' row '1'
    Then [common] I click field 'modelTitle' row '0'
    Then [common] Field 'chartTitle' row '1' attribute 'value' should be 'Bar Vertical Grouped'        

    Then [common] I wait "1" seconds

    Then [common] I click field 'chartType' row '1'
    Then [common] I click field 'chartTypeBarVerticalGrouped' row '0'
