Feature: dev-chart-bar-vertical-normalized

  Scenario: dev-chart-bar-vertical-normalized
    Given [common] scenario 'dev-chart-bar-vertical-normalized'
    ...
    Then [common] I enter 'Bar Vertical Normalized' into 'chartTitle' row '1'
    Then [common] I click field 'modelTitle' row '0'
    Then [common] Field 'chartTitle' row '1' attribute 'value' should be 'Bar Vertical Normalized'        

    Then [common] I wait "1" seconds

    Then [common] I click field 'chartType' row '1'
    Then [common] I click field 'chartTypeBarVerticalNormalized' row '0'
