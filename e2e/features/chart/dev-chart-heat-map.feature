Feature: dev-chart-heat-map

  Scenario: dev-chart-heat-map
    Given [common] scenario 'dev-chart-heat-map'
    ...
    Then [common] I enter 'Heat Map' into 'chartTitle' row '1'
    Then [common] I click field 'modelTitle' row '0'
    Then [common] Field 'chartTitle' row '1' attribute 'value' should be 'Heat Map'        

    Then [common] I wait "1" seconds

    Then [common] I click field 'chartType' row '1'
    Then [common] I click field 'chartTypeHeatMap' row '0'
