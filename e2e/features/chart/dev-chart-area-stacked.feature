Feature: dev-chart-area-stacked

  Scenario: dev-chart-area-stacked
    Given [common] scenario 'dev-chart-area-stacked'
    ...
    Then [common] I enter 'Area Stacked' into 'chartTitle' row '1'
    Then [common] I click field 'modelTitle' row '0'
    Then [common] Field 'chartTitle' row '1' attribute 'value' should be 'Area Stacked'        

    Then [common] I wait "1" seconds

    Then [common] I click field 'chartType' row '1'
    Then [common] I click field 'chartTypeAreaStacked' row '0'
