Feature: dev-chart-bar-horizontal-normalized

  Scenario: dev-chart-bar-horizontal-normalized
    Given [common] scenario 'dev-chart-bar-horizontal-normalized'
    ...
    Then [common] I enter 'Bar Horizontal Normalized' into 'chartTitle' row '1'
    Then [common] I click field 'modelTitle' row '0'
    Then [common] Field 'chartTitle' row '1' attribute 'value' should be 'Bar Horizontal Normalized'        

    Then [common] I wait "1" seconds

    Then [common] I click field 'chartType' row '1'
    Then [common] I click field 'chartTypeBarHorizontalNormalized' row '0'
