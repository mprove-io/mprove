Feature: dev-chart-bar-vertical-stacked

  Scenario: dev-chart-bar-vertical-stacked
    Given [common] scenario 'dev-chart-bar-vertical-stacked'
    ...
    Then [common] I enter 'Bar Vertical Stacked' into 'chartTitle' row '1'
    Then [common] I click field 'modelTitle' row '0'
    Then [common] Field 'chartTitle' row '1' attribute 'value' should be 'Bar Vertical Stacked'        

    Then [common] I wait "1" seconds

    Then [common] I click field 'chartType' row '1'
    Then [common] I click field 'chartTypeBarVerticalStacked' row '0'
