Feature: dev-chart-line

  Scenario: dev-chart-line
    Given [common] scenario 'dev-chart-line'
    ...
    Then [common] I enter 'Line' into 'chartTitle' row '1'
    Then [common] I click field 'modelTitle' row '0'
    Then [common] Field 'chartTitle' row '1' attribute 'value' should be 'Line'        

    Then [common] I wait "1" seconds

    Then [common] I click field 'chartType' row '1'
    Then [common] I click field 'chartTypeLine' row '0'
    ...
    Then [common] Flag 'chartTimelineToggle' row '1' should be unchecked
    Then [common] I click field 'chartTimelineToggleInner' row '1'
    Then [common] Flag 'chartTimelineToggle' row '1' should be checked         
    Then [common] I click field 'chartTimelineToggleInner' row '1'
    Then [common] Flag 'chartTimelineToggle' row '1' should be unchecked

    Then [common] I wait "1" seconds

    Then [common] Flag 'chartAutoScaleToggle' row '1' should be checked
    Then [common] I click field 'chartAutoScaleToggleInner' row '1'
    Then [common] Flag 'chartAutoScaleToggle' row '1' should be unchecked         
    Then [common] I click field 'chartAutoScaleToggleInner' row '1'
    Then [common] Flag 'chartAutoScaleToggle' row '1' should be checked
