...
export class FractionStringComponent implements OnInit {
  ...
  getValueBrick(fractionType: api.FractionTypeEnum, value: string) {
    let newBrick =
      fractionType === api.FractionTypeEnum.StringIsEqualTo ? `-${value}-` :
        fractionType === api.FractionTypeEnum.StringContains ? `%${value}%` :
          fractionType === api.FractionTypeEnum.StringStartsWith ? `${value}%` :
            fractionType === api.FractionTypeEnum.StringEndsWith ? `%${value}` :
              fractionType === api.FractionTypeEnum.StringIsNotEqualTo ? `not -${value}-` :
                fractionType === api.FractionTypeEnum.StringDoesNotContain ? `not %${value}%` :
                  fractionType === api.FractionTypeEnum.StringDoesNotStartWith ? `${value}% not` :
                    fractionType === api.FractionTypeEnum.StringDoesNotEndWith ? `not %${value}` : '';
