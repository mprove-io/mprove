...
export const BACKEND_FAIL = ngrxType('BACKEND_FAIL');

import { ngrxType } from '@app/ngrx/ngrx-type';

export * from '../store-effects/files/_files.action-types';
export * from '../store-effects/folders/_folders.action-types';
export * from '../store-effects/state/_state.action-types';
