...
export class BackendService {
  ...
  setProjectQuerySizeLimit(payload: api.SetProjectQuerySizeLimitRequestBodyPayload):
    Observable<api.SetProjectQuerySizeLimitResponse200Body> {

    return this.myHttpService.req(api.PATH_SET_PROJECT_QUERY_SIZE_LIMIT, payload);
  }

  setProjectTimezone(payload: api.SetProjectTimezoneRequestBodyPayload):
    Observable<api.SetProjectTimezoneResponse200Body> {

    return this.myHttpService.req(api.PATH_SET_PROJECT_TIMEZONE, payload);
  }

  setProjectWeekStart(payload: api.SetProjectWeekStartRequestBodyPayload):
  ...
  runQueries(payload: api.RunQueriesRequestBodyPayload):
    Observable<api.RunQueriesResponse200Body> {

    return this.myHttpService.req(api.PATH_RUN_QUERIES, payload);
  }

  runQueriesDry(payload: api.RunQueriesDryRequestBodyPayload):
  ...
  commitRepo(payload: api.CommitRepoRequestBodyPayload):
   ...
   * @param payload
   */
  pullRepo(payload: api.PullRepoRequestBodyPayload):
    Observable<api.PullRepoResponse200Body> {

    return this.myHttpService.req(api.PATH_PULL_REPO, payload);
  }

  pushRepo(payload: api.PushRepoRequestBodyPayload):
    Observable<api.PushRepoResponse200Body> {

    return this.myHttpService.req(api.PATH_PUSH_REPO, payload);
  }

  regenerateRepoRemotePublicKey(payload: api.RegenerateRepoRemotePublicKeyRequestBodyPayload):
    Observable<api.RegenerateRepoRemotePublicKeyResponse200Body> {

    return this.myHttpService.req(api.PATH_REGENERATE_REPO_REMOTE_PUBLIC_KEY, payload);
  }

  regenerateRepoRemoteWebhook(payload: api.RegenerateRepoRemoteWebhookRequestBodyPayload):
    Observable<api.RegenerateRepoRemoteWebhookResponse200Body> {

    return this.myHttpService.req(api.PATH_REGENERATE_REPO_REMOTE_WEBHOOK, payload);
  }

  revertRepoToLastCommit(payload: api.RevertRepoToLastCommitRequestBodyPayload):
  ...
  revertRepoToProduction(payload: api.RevertRepoToProductionRequestBodyPayload):
   ...
   * @param payload
   */
  cancelSubscriptions(payload: api.CancelSubscriptionsRequestBodyPayload):
   ...
   * @param payload
   */
  switchAnalyticsSubscriptionPlan(payload: api.SwitchAnalyticsSubscriptionPlanRequestBodyPayload):
    Observable<api.SwitchAnalyticsSubscriptionPlanResponse200Body> {

    return this.myHttpService.req(api.PATH_SWITCH_ANALYTICS_SUBSCRIPTION_PLAN, payload);
  }
   ...
   * @param payload
   */
  logoutUser(payload: api.LogoutUserRequestBodyPayload):
    Observable<api.LogoutUserResponse200Body> {

    return this.myHttpService.req(api.PATH_LOGOUT_USER, payload);
  }

  setUserName(payload: api.SetUserNameRequestBodyPayload):
   ...
   * @param payload
   */
  setUserPicture(payload: api.SetUserPictureRequestBodyPayload):
    Observable<api.SetUserPictureResponse200Body> {

    return this.myHttpService.req(api.PATH_SET_USER_PICTURE, payload);
  }

  setUserTimezone(payload: api.SetUserTimezoneRequestBodyPayload):
