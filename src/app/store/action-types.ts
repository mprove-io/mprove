...
export const UPDATE_DASHBOARDS_STATE = ngrxType('[Dashboards] Update Dashboards State');
export const RESET_DASHBOARDS_STATE = ngrxType('[Dashboards] Reset Dashboards State');
export const CLEAN_DASHBOARDS_STATE = ngrxType('[Dashboards] Clean Dashboards State');
...
export const CREATE_FOLDER_SUCCESS = ngrxType('[Folders] Create Folder Success');
...
export const DELETE_FOLDER_SUCCESS = ngrxType('[Folders] Delete Folder Success');
...
export const RENAME_FOLDER_SUCCESS = ngrxType('[Folders] Rename Folder Success');
export const RENAME_FOLDER_FAIL = ngrxType('[Folders] Rename Folder Fail');

// LAYOUT

export const UPDATE_LAYOUT_PROJECT_ID = ngrxType('[Layout] Update Layout Project Id');
...
export const SET_LAYOUT_NEED_SAVE_TRUE = ngrxType('[Layout] Set Layout Need Save True');
export const SET_LAYOUT_NEED_SAVE_FALSE = ngrxType('[Layout] Set Layout Need Save False');
export const UPDATE_LAYOUT_FILE_ID = ngrxType('[Layout] Update Layout File Id');
export const UPDATE_LAYOUT_MCONFIG_ID = ngrxType('[Layout] Update Layout Mconfig Id');
export const UPDATE_LAYOUT_MODEL_ID = ngrxType('[Layout] Update Layout Model Id');
export const UPDATE_LAYOUT_DASHBOARD_ID = ngrxType('[Layout] Update Layout Dashboard Id');
export const UPDATE_LAYOUT_QUERY_ID = ngrxType('[Layout] Update Layout Query Id');
export const UPDATE_LAYOUT_CHART_ID = ngrxType('[Layout] Update Layout Chart Id');
...
export const UPDATE_LAYOUT_LAST_WS_MSG_TS = ngrxType('[Layout] Update Layout WebSocket Message TimeStamp');

// MCONFIGS

export const CREATE_MCONFIG = ngrxType('[Mconfigs] Create Mconfig');
export const CREATE_MCONFIG_SUCCESS = ngrxType('[Mconfigs] Create Mconfig Success');
export const CREATE_MCONFIG_FAIL = ngrxType('[Mconfigs] Create Mconfig Fail');

export const UPDATE_MCONFIGS_STATE = ngrxType('[Mconfigs] Update Mconfigs State');
...
export const CREATE_MEMBER_SUCCESS = ngrxType('[Members] Create Member Success');
...
export const DELETE_MEMBER_SUCCESS = ngrxType('[Members] Delete Member Success');
...
export const CREATE_DASHBOARD_SUCCESS = ngrxType('[Multi] Create Dashboard Success');
export const CREATE_DASHBOARD_FAIL = ngrxType('[Multi] Create Dashboard Fail');

export const CREATE_MCONFIG_AND_QUERY = ngrxType('[Multi] Create Mconfig And Query');
export const CREATE_MCONFIG_AND_QUERY_SUCCESS = ngrxType('[Multi] Create Mconfig And Query Success');
export const CREATE_MCONFIG_AND_QUERY_FAIL = ngrxType('[Multi] Create Mconfig And Query Fail');

export const SET_LIVE_QUERIES = ngrxType('[Multi] Set Live Queries');
export const SET_LIVE_QUERIES_SUCCESS = ngrxType('[Multi] Set Live Queries Success');
export const SET_LIVE_QUERIES_FAIL = ngrxType('[Multi] Set Live Queries Fail');

// PAYMENTS

export const UPDATE_PAYMENTS_STATE = ngrxType('[Payments] Update Payments State');
export const RESET_PAYMENTS_STATE = ngrxType('[Payments] Reset Payments State');

// PROJECTS

export const UPDATE_PROJECTS_STATE = ngrxType('[Projects] Update Projects State');
...
export const CREATE_PROJECT_SUCCESS = ngrxType('[Projects] Create Project Success');
export const CREATE_PROJECT_FAIL = ngrxType('[Projects] Create Project Fail');

export const SET_PROJECT_CREDENTIALS = ngrxType('[Projects] Set Project Credentials');
export const SET_PROJECT_CREDENTIALS_SUCCESS = ngrxType('[Projects] Set Project Credentials Success');
export const SET_PROJECT_CREDENTIALS_FAIL = ngrxType('[Projects] Set Project Credentials Fail');

export const SET_PROJECT_QUERY_SIZE_LIMIT = ngrxType('[Projects] Set Project Query Size Limit');
export const SET_PROJECT_QUERY_SIZE_LIMIT_SUCCESS = ngrxType('[Projects] Set Project Query Size Limit Success');
export const SET_PROJECT_QUERY_SIZE_LIMIT_FAIL = ngrxType('[Projects] Set Project Query Size Limit Fail');

export const SET_PROJECT_WEEK_START = ngrxType('[Projects] Set Project Week Start');
export const SET_PROJECT_WEEK_START_SUCCESS = ngrxType('[Projects] Set Project Week Start Success');
export const SET_PROJECT_WEEK_START_FAIL = ngrxType('[Projects] Set Project Week Start Fail');

export const SET_PROJECT_TIMEZONE = ngrxType('[Projects] Set Project Timezone');
export const SET_PROJECT_TIMEZONE_SUCCESS = ngrxType('[Projects] Set Project Timezone Success');
export const SET_PROJECT_TIMEZONE_FAIL = ngrxType('[Projects] Set Project Timezone Fail');

export const DELETE_PROJECT = ngrxType('[Projects] Delete Project');
export const DELETE_PROJECT_SUCCESS = ngrxType('[Projects] Delete Project Success');
...
export const CANCEL_QUERIES_SUCCESS = ngrxType('[Queries] Cancel Queries Success');
...
export const RUN_QUERIES_DRY_SUCCESS = ngrxType('[Queries] Run Queries Dry Success');
...
export const SET_USER_TIMEZONE_SUCCESS = ngrxType('[User] Set User Timezone Success');
...
export const SET_USER_PICTURE_SUCCESS = ngrxType('[User] Set User Picture Success');
...
export const REGENERATE_REPO_REMOTE_PUBLIC_KEY = ngrxType('[Repos] Regenerate Repo Remote Public Key');
export const REGENERATE_REPO_REMOTE_PUBLIC_KEY_SUCCESS =
  ngrxType('[Repos] Regenerate Repo Remote Public Key Success');
export const REGENERATE_REPO_REMOTE_PUBLIC_KEY_FAIL = ngrxType('[Repos] Regenerate Repo Remote Public Key Fail');

export const REGENERATE_REPO_REMOTE_WEBHOOK = ngrxType('[Repos] Regenerate Repo Remote Webhook');
export const REGENERATE_REPO_REMOTE_WEBHOOK_SUCCESS = ngrxType('[Repos] Regenerate Repo Remote Webhook Success');
export const REGENERATE_REPO_REMOTE_WEBHOOK_FAIL = ngrxType('[Repos] Regenerate Repo Remote Webhook Fail');

export const REVERT_REPO_TO_PRODUCTION = ngrxType('[Repos] Revert Repo To Production');
export const REVERT_REPO_TO_PRODUCTION_SUCCESS = ngrxType('[Repos] Revert Repo To Production Success');
export const REVERT_REPO_TO_PRODUCTION_FAIL = ngrxType('[Repos] Revert Repo To Production Fail');

export const REVERT_REPO_TO_LAST_COMMIT = ngrxType('[Repos] Revert Repo To Last Commit');
export const REVERT_REPO_TO_LAST_COMMIT_SUCCESS = ngrxType('[Repos] Revert Repo To Last Commit Success');
export const REVERT_REPO_TO_LAST_COMMIT_FAIL = ngrxType('[Repos] Revert Repo To Last Commit Fail');

export const SET_REPO_REMOTE_URL = ngrxType('[Repos] Set Repo Remote Url');
export const SET_REPO_REMOTE_URL_SUCCESS = ngrxType('[Repos] Set Repo Remote Url Success');
export const SET_REPO_REMOTE_URL_FAIL = ngrxType('[Repos] Set Repo Remote Url Fail');
...
export const UPDATE_SUBSCRIPTIONS_STATE = ngrxType('[Subscriptions] Update Subscriptions State');
export const RESET_SUBSCRIPTIONS_STATE = ngrxType('[Subscriptions] Reset Subscriptions State');

export const CANCEL_SUBSCRIPTIONS = ngrxType('[Subscriptions] Cancel Subscriptions');
export const CANCEL_SUBSCRIPTIONS_SUCCESS = ngrxType('[Subscriptions] Cancel Subscriptions Success');
export const CANCEL_SUBSCRIPTIONS_FAIL = ngrxType('[Subscriptions] Cancel Subscriptions Fail');

export const SWITCH_ANALYTICS_SUBSCRIPTION_PLAN = ngrxType('[Subscriptions] Switch Analytics Subscription Plan');
export const SWITCH_ANALYTICS_SUBSCRIPTION_PLAN_SUCCESS =
  ngrxType('[Subscriptions] Switch Analytics Subscription Plan Success');
export const SWITCH_ANALYTICS_SUBSCRIPTION_PLAN_FAIL =
  ngrxType('[Subscriptions] Switch Analytics Subscription Plan Fail');
...
export const OPEN_WEBSOCKET_SUCCESS = ngrxType('[Websocket] Open Websocket Success');

export const CLOSE_WEBSOCKET = ngrxType('[Websocket] Close Websocket');
export const CLOSE_WEBSOCKET_SUCCESS = ngrxType('[Websocket] Close Websocket Success');

export const UPDATE_WEBSOCKET_INIT_ID = ngrxType('[Websocket] Update Websocket Init Id');
export const RESET_WEBSOCKET_STATE = ngrxType('[Websocket] Reset Websocket State');
