...
export function makeMember(item: {
  ...
  return {
    ...
    is_editor: helper.isNotNullAndNotEmpty(item.is_editor) ? item.is_editor : enums.bEnum.FALSE,
    is_admin: helper.isNotNullAndNotEmpty(item.is_admin) ? item.is_admin : enums.bEnum.FALSE,
