    ...
    x.reports.forEach(report => {
      ...
      Object.keys(report.data)
        ...
        .forEach(parameter => {
          ...
          if (Array.isArray((<any>report.data)[parameter]) && ['y_fields', 'hide_columns'].indexOf(parameter) < 0) {
            // error e173
            ErrorsCollector.addError(new AmError({
          ...
          if (!!(<any>report.data)[parameter] && (<any>report.data)[parameter].constructor === Object) {
            // error e174
            ErrorsCollector.addError(new AmError({
