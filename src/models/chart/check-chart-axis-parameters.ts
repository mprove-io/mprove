    ...
    x.reports.forEach(report => {
      ...
      Object.keys(report.axis)
        ...
        .forEach(parameter => {
          ...
          if (!!(<any>report.axis)[parameter] && (<any>report.axis)[parameter].constructor === Object) {
            // error e186
            ErrorsCollector.addError(new AmError({
          ...
          if ([
            ...
            'show_y_axis_label',
            'show_axis',
          ].indexOf(parameter) > -1 && !(<any>report.axis)[parameter].toString().match(ApRegex.TRUE_FALSE())) {
            // error e187
            ErrorsCollector.addError(new AmError({
