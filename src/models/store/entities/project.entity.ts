...
export class ProjectEntity implements ProjectInterface {
  ...
  @Column({ type: constants.PROJECT_BIGQUERY_CLIENT_EMAIL_DATATYPE, nullable: true })
  bigquery_client_email: string;


  @Column({ type: constants.PROJECT_BIGQUERY_CREDENTIALS_DATATYPE, nullable: true })
  bigquery_credentials: string;


  @Column({ type: constants.PROJECT_BIGQUERY_CREDENTIALS_FILE_PATH_DATATYPE, nullable: true })
  ...
  @Column({ type: constants.PROJECT_ANALYTICS_PLAN_ID_DATATYPE, nullable: true })
  analytics_plan_id: string;


  @Column({ type: constants.PROJECT_ANALYTICS_MAX_PLAN_ID_DATATYPE, nullable: true })
  analytics_max_plan_id: string;


  @Column({ type: constants.PROJECT_ANALYTICS_SUBSCRIPTION_ID_DATATYPE, nullable: true })
