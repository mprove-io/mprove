...
export class QueryEntity implements QueryInterface {
  ...
  @Column({ type: constants.QUERY_LAST_COMPLETE_DURATION_DATATYPE, nullable: true })
  ...
  @Column({ type: constants.QUERY_BIGQUERY_QUERY_JOB_ID_DATATYPE, nullable: true })
  bigquery_query_job_id: string;


  @Column({ type: constants.QUERY_BIGQUERY_COPY_JOB_ID_DATATYPE, nullable: true })
