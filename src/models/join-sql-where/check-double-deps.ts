    ...
    x.joins
      ...
      .forEach(join => {
        ...
        Object.keys(join.sql_where_double_deps).forEach(depAs => {
          ...
          Object.keys(join.sql_where_double_deps[depAs]).forEach(depFieldName => {
            ...
            if (!depField) {
              ...
              ErrorsCollector.addError(new AmError({
                ...
                message: `Join "sql_where:" can not reference filters. ` +
              ...
              ErrorsCollector.addError(new AmError({
                ...
                message: `Join "sql_where:" can not reference measures. ` +
              ...
              ErrorsCollector.addError(new AmError({
                ...
                message: `Join "sql_where:" can not reference calculations. ` +
