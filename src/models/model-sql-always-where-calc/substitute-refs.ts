...
export function substituteRefs(item: { models: interfaces.Model[] }) {
      ...
      while ((r = reg.exec(sqlAlwaysWhereCalcReal))) {
        ...
        switch (true) {
          case referenceField.field_class ===
            ...
            sqlAlwaysWhereCalcReal = ApRegex.replaceSingleRefs(
          ...
          case referenceField.field_class === enums.FieldClassEnum.Dimension: {
            x.sql_always_where_calc_deps_after_singles[fieldName] =
            ...
            x.sql_always_where_calc_force_dims['mf'][fieldName] =
              x.sql_always_where_calc_line_num;
      ...
      while ((r2 = reg2.exec(sqlAlwaysWhereCalcReal))) {
        ...
        switch (true) {
          case depField.field_class === enums.FieldClassEnum.Calculation: {
            sqlAlwaysWhereCalcReal = ApRegex.replaceAndConvert(
              sqlAlwaysWhereCalcReal,
              depField.sql_real,
              asName,
              depName
          ...
          case depField.field_class === enums.FieldClassEnum.Dimension: {
            ...
            x.sql_always_where_calc_force_dims[asName][depName] =
              x.sql_always_where_calc_line_num;
