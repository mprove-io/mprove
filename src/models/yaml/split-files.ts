    ...
    switch (file.ext) {
      ...
      case '.view': {
        if (file.name === file.view + '.view') {
          ...
          let labelLineNum: number = file.label_line_num ? file.label_line_num : 0;

          views.push(Object.assign({}, file, {
            name: file.view,
            file: file.name,
            label: label,
      ...
      case '.model': {
        if (file.name === file.model + '.model') {
          ...
          models.push(Object.assign({}, file, {
            name: file.model,
            file: file.name,
            label: label,
            label_line_num: labelLineNum
      ...
      case '.dashboard': {
        if (file.name === file.dashboard + '.dashboard') {
          ...
          dashboards.push(Object.assign({}, file, {
            name: file.dashboard,
            file: file.name,
          }));
