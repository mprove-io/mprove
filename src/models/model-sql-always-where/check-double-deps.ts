...
export function checkDoubleDeps(item: {
  ...
  item.models.forEach(x => {
    ...
    Object.keys(x.sql_always_where_double_deps).forEach(depAs => {
      ...
      Object.keys(x.sql_always_where_double_deps[depAs]).forEach(depFieldName => {
        ...
        if (!depField) {
          ...
          ErrorsCollector.addError(new AmError({
            ...
            message: `sql_always_where can not reference filters. ` +
          ...
          ErrorsCollector.addError(new AmError({
            ...
            message: `sql_always_where can not reference measures. ` +
          ...
          ErrorsCollector.addError(new AmError({
            ...
            message: `sql_always_where can not reference calculations. ` +
