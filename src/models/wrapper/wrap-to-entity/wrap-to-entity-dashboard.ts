...
export function wrapToEntityDashboard(dashboard: api.Dashboard): entities.DashboardEntity {
  ...
  return {
    ...
    access_users: dashboard.access_users ? JSON.stringify(dashboard.access_users) : null,
