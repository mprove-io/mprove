...
export function wrapToApiRepo(repo: entities.RepoEntity): api.Repo {
  return {
    ...
    remote_push_access_is_ok: helper.benumToBoolean(
      repo.remote_push_access_is_ok
    ),
    remote_push_error_message: repo.remote_push_error_message,
    remote_need_manual_pull: helper.benumToBoolean(
      repo.remote_need_manual_pull
    ),
    remote_last_pull_ts: Number(repo.remote_last_pull_ts),
    remote_pull_access_is_ok: helper.benumToBoolean(
      repo.remote_pull_access_is_ok
    ),
