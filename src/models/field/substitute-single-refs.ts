      ...
      switch (true) {
        ...
        case field.field_class === enums.FieldClassEnum.Dimension: {
          ...
          while (r = reg.exec(sqlReal)) {
            ...
            sqlReal = ApRegex.replaceSingleRefs(sqlReal, reference, referenceField.sql);
          }
          ...
          if (field.result === enums.FieldExtResultEnum.Ts) {
            ...
            while (r2 = reg2.exec(sqlTimestampReal)) {
              ...
              sqlTimestampReal = ApRegex.replaceSingleRefs(sqlTimestampReal, reference2, referenceField2.sql);
            }
        ...
        case (field.field_class === enums.FieldClassEnum.Measure && x.ext === enums.FileExtensionEnum.Model): {
          ...
          if ([
            ...
            while (r2 = reg2.exec(sqlKeyReal)) {
              ...
              sqlKeyReal = ApRegex.replaceSingleRefs(sqlKeyReal, reference2, referenceField2.sql);
            }
        ...
        case (field.field_class === enums.FieldClassEnum.Measure && x.ext === enums.FileExtensionEnum.View): {
          ...
          while (r = reg.exec(sqlReal)) {
            ...
            x.fields_deps_after_singles[field.name][reference] = field.sql_line_num;
          }
          ...
          if ([
            ...
            while (r2 = reg2.exec(sqlKeyReal)) {
              ...
              x.fields_deps_after_singles[field.name][reference2] = field.sql_key_line_num;
            }
        ...
        case (field.field_class === enums.FieldClassEnum.Calculation): {
          ...
          let deps: { // declared here, initialized inside while
            dep_name: string;
          ...
          deps.forEach(dep => {
            x.fields_deps_after_singles[field.name][dep.dep_name] = dep.dep_line_num;
          });
