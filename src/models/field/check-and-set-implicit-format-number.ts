  ...
  item.entities.forEach((x: T) => {
    ...
    x.fields.forEach(field => {
      ...
      if (field.result === enums.FieldExtResultEnum.Number) {
        ...
        if (typeof field.format_number === 'undefined' || field.format_number === null) {
          // set default
          field.format_number = '';
        ...
        if (typeof field.currency_prefix === 'undefined' || field.currency_prefix === null) {
          // set default
          field.currency_prefix = '$';
          field.currency_prefix_line_num = 0;
        }

        if (typeof field.currency_suffix === 'undefined' || field.currency_suffix === null) {
          // set default
        ...
        if (typeof field.format_number !== 'undefined' && field.format_number !== null) {
          ...
          ErrorsCollector.addError(new AmError({
            ...
            message: `format_number can only be used with fields where result is "number". ` +
        ...
        if (typeof field.currency_prefix !== 'undefined' && field.currency_prefix !== null) {
          ...
          ErrorsCollector.addError(new AmError({
            ...
            message: `currency_prefix can only be used with fields where result is "number". ` +
              `Found field result "${field.result}".`,
            lines: [{
        ...
        if (typeof field.currency_suffix !== 'undefined' && field.currency_suffix !== null) {
          ...
          ErrorsCollector.addError(new AmError({
            ...
            message: `currency_suffix can only be used with fields where result is "number". ` +
              `Found field result "${field.result}".`,
            lines: [{
