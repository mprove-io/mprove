...
export async function revertRepoToProduction(req: Request, res: Response) {
  ...
  let payload: api.RevertRepoToProductionRequestBodyPayload = validator.getPayload(req);
  ...
  await git.revertRepoToProduction({
    ...
    .catch(e => helper.reThrow(e, enums.gitErrorsEnum.GIT_REVERT_REPO_TO_PRODUCTION));
