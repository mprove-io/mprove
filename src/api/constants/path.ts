...
export const PATH_GET_DASHBOARD_MCONFIG_AND_QUERIES = '/multi.getDashboardMconfigsQueries';
...
export const PATH_SET_PROJECT_QUERY_SIZE_LIMIT = '/projects.setProjectQuerySizeLimit';
...
export const PATH_GET_QUERY_WITH_DEP_QUERIES = '/queries.getQueryWithDepQueries';
...
export const PATH_REGENERATE_REPO_REMOTE_PUBLIC_KEY = '/repos.regenerateRepoRemotePublicKey';
export const PATH_REGENERATE_REPO_REMOTE_WEBHOOK = '/repos.regenerateRepoRemoteWebhook';
...
export const PATH_SWITCH_ANALYTICS_SUBSCRIPTION_PLAN = '/subscriptions.switchAnalyticsSubscriptionPlan';
