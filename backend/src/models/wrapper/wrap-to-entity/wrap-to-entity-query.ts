...
export function wrapToEntityQuery(query: api.Query): entities.QueryEntity {
  return {
    ...
    pdt_trigger_sql: query.pdt_trigger_sql ? query.pdt_trigger_sql : null,
    pdt_trigger_time: query.pdt_trigger_time ? query.pdt_trigger_time : null,
    ...
    pdt_trigger_sql_postgres_query_job_id: null,
