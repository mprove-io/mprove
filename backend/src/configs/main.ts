...
export const DISK_BACKEND_PROJECTS_PATH = '/mprove_data/backend/projects';
export const DISK_BACKEND_BIGQUERY_CREDENTIALS_PATH =
  '/mprove_data/backend/bigquery_credentials';
export const DISK_BACKEND_TEST_CREDENTIALS_PATH =
