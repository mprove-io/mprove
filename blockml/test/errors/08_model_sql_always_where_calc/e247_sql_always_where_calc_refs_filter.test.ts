...
// yarn jest test/errors/08_model_sql_always_where_calc/e247_sql_always_where_calc_refs_filter.test.ts
jest.setTimeout(30000);
test('testName', () => {
  expect.assertions(3);

  return ApStruct.rebuildStruct({
    dir: 'test/errors/08_model_sql_always_where_calc/e247',
