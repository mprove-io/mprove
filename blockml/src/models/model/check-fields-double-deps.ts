...
export function checkFieldsDoubleDeps(item: { models: interfaces.Model[] }) {
          ...
          ErrorsCollector.addError(
            new AmError({
              ...
              message:
                ...
                `Check "as:" values.`,
              lines: Object.keys(x.fields_double_deps[fieldName][as]).map(
                d => ({
          ...
          if (!depField) {
            ...
            ErrorsCollector.addError(
              new AmError({
                ...
                message:
                  `found referencing to field "${depName}" ` +
