export enum ErEnum {
  ...
  BACKEND_ORG_ALREADY_EXIST = 'BACKEND_ORG_ALREADY_EXIST',

  BACKEND_ORG_NOT_FOUND = 'BACKEND_ORG_NOT_FOUND',
  BACKEND_FORBIDDEN_ORG = 'BACKEND_FORBIDDEN_ORG',

  BACKEND_NEW_OWNER_IS_NOT_FOUND = 'BACKEND_NEW_OWNER_IS_NOT_FOUND',

  BACKEND_ORG_IS_NOT_EXIST = 'BACKEND_ORG_IS_NOT_EXIST'
}
