...
import { zFractionControl } from '#common/zod/z-query-info/z-fraction-control';
import { zFractionSubTypeOption } from '#common/zod/z-query-info/z-fraction-sub-type-option';

export let zFraction = z.object({
  ...
  type: z.enum(FractionTypeEnum).nullish(),
