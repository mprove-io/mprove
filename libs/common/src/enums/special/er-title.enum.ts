export enum ErTitleEnum {
  ...
  // visualization
  VIS_MISSING_REPORTS = 'VIS_MISSING_REPORTS',
  VIS_TOO_MANY_REPORTS = 'VIS_TOO_MANY_REPORTS',
  ...
  VIS_REPORT_CAN_NOT_HAVE_LISTEN_FILTERS = 'VIS_REPORT_CAN_NOT_HAVE_LISTEN_FILTERS',
