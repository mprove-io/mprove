export enum ErTitleEnum {
  ...
  ROW_APPLY_TO_WRONG_REFERENCE = 'ROW_APPLY_TO_WRONG_REFERENCE',
  ROW_APPLY_TO_REFS_MISSING_MODEL_FIELD = 'ROW_APPLY_TO_REFS_MISSING_MODEL_FIELD',
  ROW_APPLY_TO_REFS_MISSING_ALIAS = 'ROW_APPLY_TO_REFS_MISSING_ALIAS',
  ROW_APPLY_TO_REFS_MISSING_VIEW_FIELD = 'ROW_APPLY_TO_REFS_MISSING_VIEW_FIELD',

  ROW_PARAMETER_WRONG_COMBINATION = 'ROW_PARAMETER_WRONG_COMBINATION',
  ROW_APPLY_TO_CONDITIONS_IS_EMPTY = 'ROW_APPLY_TO_CONDITIONS_IS_EMPTY',
  ROW_APPLY_TO_WRONG_CONDITIONS = 'ROW_APPLY_TO_WRONG_CONDITIONS',
