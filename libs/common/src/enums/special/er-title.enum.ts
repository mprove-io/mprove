export enum ErTitleEnum {
  ...
  UNKNOWN_VIS_PARAMETER = 'UNKNOWN_VIS_PARAMETER',
  ...
  // visualization
  VIS_MISSING_TILES = 'VIS_MISSING_TILES',
  VIS_TOO_MANY_TILES = 'VIS_TOO_MANY_TILES',
  ...
  VIS_TILE_CAN_NOT_HAVE_LISTEN_FILTERS = 'VIS_TILE_CAN_NOT_HAVE_LISTEN_FILTERS',
