export enum FuncEnum {
  ...
  ApplyStorePresets = '01.1-store-start/01.1-apply-store-presets',
  CheckStoreFieldGroups = '01.1-store-start/01.2-check-store-field-groups',
  CheckStoreFieldTimeGroups = '01.1-store-start/01.3-check-store-field-time-groups',
  ...
  BuildMalloyModel = '01.2-mod-start/02-build-malloy-model',
  BuildMods = '01.2-mod-start/03-build-mods',
  ...
  CheckStoreFieldDetail = '02-field/12.2-check-store-field-detail',
  ...
  CheckChartPlateParameters = '15-mconfig-chart/04-check-chart-plate-parameters',
