export enum ErEnum { // TODO: check ErEnum references
  ...
  CHAT_APP_TERMINATED = 'CHAT_APP_TERMINATED',
  CHAT_UNCAUGHT_EXCEPTION = 'CHAT_UNCAUGHT_EXCEPTION',
  CHAT_UNHANDLED_REJECTION_REASON = 'CHAT_UNHANDLED_REJECTION_REASON',
  CHAT_UNHANDLED_REJECTION_ERROR = 'CHAT_UNHANDLED_REJECTION_ERROR',

  CHAT_WRONG_ENV_VALUES = 'CHAT_WRONG_ENV_VALUES',

  CHAT_WRONG_REQUEST_INFO_NAME = 'CHAT_WRONG_REQUEST_INFO_NAME',
  CHAT_WRONG_REQUEST_PARAMS = 'CHAT_WRONG_REQUEST_PARAMS',

  CHAT_OPENCODE_ERROR = 'CHAT_OPENCODE_ERROR',
  CHAT_CREATE_SESSION_FAILED = 'CHAT_CREATE_SESSION_FAILED',
  CHAT_SESSION_ID_NOT_RETURNED = 'CHAT_SESSION_ID_NOT_RETURNED',
  CHAT_PROMPT_FAILED = 'CHAT_PROMPT_FAILED',
  CHAT_ANSWER_IS_EMPTY = 'CHAT_ANSWER_IS_EMPTY',
