export enum ErEnum {
  ...
  BLOCKML_WRONG_TIME_RANGE_BRICKS_LENGTH = 'BLOCKML_WRONG_TIME_RANGE_BRICKS_LENGTH',
  BLOCKML_WRONG_TIME_RANGE_FIELD_RESULT = 'BLOCKML_WRONG_TIME_RANGE_FIELD_RESULT',

  BLOCKML_WRONG_MODEL_TYPE = 'BLOCKML_WRONG_MODEL_TYPE',
