...
// yarn jest test/unit/08_model_sql_always_where_calc/e257_sql_always_where_calc_apply_filter_references_field_that_is_not_a_filter.test.ts

jest.setTimeout(30000); test('testName', () => {
  expect.assertions(3);

  return ApStruct.rebuildStruct({
    dir: 'test/unit/08_model_sql_always_where_calc/e257',
