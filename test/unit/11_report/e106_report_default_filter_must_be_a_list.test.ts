...
// yarn jest test/unit/11_report/e106_report_default_filter_must_be_a_list.test.ts
jest.setTimeout(30000); test('testName', () => {
  expect.assertions(3);

  return ApStruct.rebuildStruct({
    dir: 'test/unit/11_report/e106',
    ...
    expect(struct.errors[0].title).toEqual(`report default filter must be a List`);
