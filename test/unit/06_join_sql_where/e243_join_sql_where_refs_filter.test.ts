...
// yarn jest test/unit/06_join_sql_where/e243_join_sql_where_refs_filter.test.ts
jest.setTimeout(30000); test('testName', () => {
  expect.assertions(3);

  return ApStruct.rebuildStruct({
    dir: 'test/unit/06_join_sql_where/e243',
    ...
    expect(struct.errors[0].message).toEqual(`Join "sql_where:" can not reference filters. ` +
