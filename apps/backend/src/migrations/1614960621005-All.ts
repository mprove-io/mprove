...
export class All1614960621005 implements MigrationInterface {
  name = 'All1614960621005';
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE TABLE `members` (`project_id` varchar(255) NOT NULL, `member_id` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, `alias` varchar(255) NULL, `first_name` varchar(255) NULL, `last_name` varchar(255) NULL, `timezone` varchar(255) NOT NULL, `status` varchar(255) NOT NULL, `is_admin` varchar(255) NOT NULL, `is_editor` varchar(255) NOT NULL, `is_explorer` varchar(255) NOT NULL, `server_ts` bigint NOT NULL, PRIMARY KEY (`project_id`, `member_id`)) ENGINE=InnoDB'
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE TABLE `projects` (`org_id` varchar(255) NOT NULL, `project_id` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `server_ts` bigint NOT NULL, PRIMARY KEY (`org_id`, `project_id`, `name`)) ENGINE=InnoDB'
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE TABLE `mconfigs` (`struct_id` varchar(255) NOT NULL, `query_id` varchar(255) NOT NULL, `mconfig_id` varchar(255) NOT NULL, `model_id` varchar(255) NOT NULL, `select` json NOT NULL, `sortings` json NOT NULL, `sorts` text NULL, `timezone` varchar(255) NOT NULL, `limit` int NOT NULL, `filters` json NOT NULL, `charts` json NOT NULL, `temp` varchar(255) NOT NULL, `server_ts` bigint NOT NULL, PRIMARY KEY (`mconfig_id`)) ENGINE=InnoDB'
    );
    await queryRunner.query(
