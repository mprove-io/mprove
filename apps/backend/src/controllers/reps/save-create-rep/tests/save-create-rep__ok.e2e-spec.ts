...
let testId = 'backend-save-create-rep__ok';
...
test('1', async t => {
  let resp2: apiToBackend.ToBackendSaveCreateRepResponse;
  ...
  try {
    ...
    let req2: apiToBackend.ToBackendSaveCreateRepRequest = {
      info: {
    ...
    resp2 =
      await helper.sendToBackend<apiToBackend.ToBackendSaveCreateRepResponse>({
        httpServer: prep.httpServer,
        loginToken: prep.loginToken,
        req: req2
      });
