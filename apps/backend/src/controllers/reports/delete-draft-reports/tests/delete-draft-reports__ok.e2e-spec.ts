...
test('1', async t => {
  let resp2: apiToBackend.ToBackendDeleteDraftReportsResponse;
  ...
  try {
    ...
    let req2: apiToBackend.ToBackendDeleteDraftReportsRequest = {
      info: {
    ...
    resp2 =
      await helper.sendToBackend<apiToBackend.ToBackendDeleteDraftReportsResponse>(
        {
          httpServer: prep.httpServer,
          loginToken: prep.loginToken,
          req: req2
