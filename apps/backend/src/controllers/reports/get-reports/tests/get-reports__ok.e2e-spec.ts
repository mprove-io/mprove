...
test('1', async t => {
  let resp: ToBackendGetReportsResponse;
  ...
  try {
    ...
    let req: ToBackendGetReportsRequest = {
      info: {
        name: ToBackendRequestInfoNameEnum.ToBackendGetReports,
        traceId: traceId,
    ...
    resp = await sendToBackend<ToBackendGetReportsResponse>({
