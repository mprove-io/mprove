      ...
      payloadCachedColumns.forEach(
        (x: ToBackendSeedRecordsRequestPayloadCachedColumnsItem) => {
          let newCachedColumn: CachedColumnTab = {
            ...
            connectionId: x.connectionId,
            envId: x.envId,
            schemaNameLc: x.schemaNameLc,
            tableNameLc: x.tableNameLc,
            columnNameLc: x.columnNameLc,
      ...
      payloadModelFieldLeafs.forEach(
        (x: ToBackendSeedRecordsRequestPayloadModelFieldLeafsItem) => {
          let newModelFieldLeaf: ModelFieldLeafTab = {
            ...
            fieldId: x.fieldId,
            fieldNameLc: x.fieldNameLc,
            fieldPath: undefined,
            fieldClass: undefined,
            fieldResult: x.fieldResult,
            fieldType: undefined,
            labelLc: x.labelLc,
            descriptionLc: x.descriptionLc,
            hidden: undefined,
            required: undefined,
            sqlNameLc: x.sqlNameLc,
            topId: undefined,
            topLabel: undefined,
            groupId: undefined,
            groupLabel: undefined,
            malloyFieldNameLc: x.malloyFieldNameLc,
