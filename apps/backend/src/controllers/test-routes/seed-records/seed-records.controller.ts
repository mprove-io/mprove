      ...
      payloadCachedColumns.forEach(
        (x: ToBackendSeedRecordsRequestPayloadCachedColumnsItem) => {
          let newCachedColumn: CachedColumnTab = {
            ...
            connectionId: x.connectionId,
            envId: x.envId,
            schemaNameLc: x.schemaName.toLowerCase(),
            tableNameLc: x.tableName.toLowerCase(),
            columnNameLc: x.columnName.toLowerCase(),
      ...
      payloadCachedParts.forEach(
        (x: ToBackendSeedRecordsRequestPayloadCachedPartsItem) => {
          let newCachedPart: CachedPartTab = {
            ...
            columnValueLc: x.columnValue?.toLowerCase(),
            count: x.count,
            keyTag: undefined,
            serverTs: undefined
          };
      ...
      payloadModelFieldLeafs.forEach(
        (x: ToBackendSeedRecordsRequestPayloadModelFieldLeafsItem) => {
          let newModelFieldLeaf: ModelFieldLeafTab = {
            ...
            fieldId: x.fieldId,
            fieldNameLc: x.fieldName?.toLowerCase(),
            fieldPath: undefined,
            fieldClass: undefined,
            fieldResult: x.fieldResult,
            fieldType: undefined,
            labelLc: x.label?.toLowerCase(),
            descriptionLc: x.description?.toLowerCase(),
            hidden: undefined,
            required: undefined,
            sqlNameLc: x.sqlName?.toLowerCase(),
            topId: undefined,
            topLabel: undefined,
            groupId: undefined,
            groupLabel: undefined,
            malloyFieldNameLc: x.malloyFieldName?.toLowerCase(),
