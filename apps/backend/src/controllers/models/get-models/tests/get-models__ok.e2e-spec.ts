...
test('1', async t => {
  let resp: ToBackendGetModelsResponse;
  ...
  try {
    ...
    let req: ToBackendGetModelsRequest = {
      info: {
        name: ToBackendRequestInfoNameEnum.ToBackendGetModels,
        traceId: traceId,
    ...
    resp = await sendToBackend<ToBackendGetModelsResponse>({
