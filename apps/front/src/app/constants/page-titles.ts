...
export const SET_NEW_PASSWORD_PAGE_TITLE = 'Set New Password';
export const NEW_PASSWORD_WAS_SET_PAGE_TITLE = 'New Password Was Set!';
...
export const METRICS_PAGE_TITLE = 'Metrics';
