export const MARKDOWN_GRAMMAR = {
  ...
  version:
    'https://github.com/microsoft/vscode-markdown-tm-grammar/commit/a8545b220dc2cb109835571ba3458ff138e97361',
  name: 'markdown',
  ...
  repository: {
    ...
    fenced_code_block_js: {
      begin:
        '(^|\\G)(\\s*)(`{3,}|~{3,})\\s*(?i:(js|jsx|javascript|es6|mjs|cjs|\\{\\.js.+?\\})((\\s+|:|,|\\{|\\?)[^`~]*)?$)',
      name: 'markup.fenced_code.block.markdown',
      end: '(^|\\G)(\\2|\\s{0,3})(\\3)\\s*$',
      beginCaptures: {
        '3': {
