export const SQL_GRAMMAR = {
  ...
  version:
    'https://github.com/microsoft/vscode-mssql/commit/13b0abd18a7cd4ca0e2384890ad2eed8dbd9043c',
  name: 'SQL',
  ...
  patterns: [
    ...
    {
      match:
        '(?i)\\b(bit_count|get_bit|left_shift|right_shift|set_bit)\\b\\s*\\(',
      captures: {
        '1': {
