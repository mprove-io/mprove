...
import type { ToDiskCreateDevRepoRequest } from '#common/zod/to-disk/03-repos/to-disk-create-dev-repo';
...
test('1', async t => {
  ...
  t.is(resp.payload.repo.repoStatus, RepoStatusEnum.NeedPull);
});
