...
let testId = 'disk-delete-file__path-traversal';
...
test('1', async t => {
  let resp: ToDiskDeleteFileResponse;
  ...
  try {
    ...
    let deleteFileRequest: ToDiskDeleteFileRequest = {
    ...
    resp = await messageService.processRequest({ request: deleteFileRequest });
  } catch (e) {
    logToConsoleDisk({
      log: e,
