...
let testId = 'disk-get-catalog-files__mprove-dir-root';
...
test('1', async t => {
  ...
  t.true(fileNodeIds.includes(`${projectId}/readme.md`));
  t.true(fileNodeIds.includes(`${projectId}/data/file1.yml`));
  t.true(fileNodeIds.includes(`${projectId}/data-ext/file2.yml`));
});
