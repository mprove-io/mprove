...
import type { ToDiskGetCatalogFilesResponsePayload } from '#common/zod/to-disk/04-catalogs/to-disk-get-catalog-files';
import { zToDiskGetCatalogFilesRequest } from '#common/zod/to-disk/04-catalogs/to-disk-get-catalog-files';
...
export class GetCatalogFilesService {
  ...
  async process(request: any) {
    ...
    let requestValid = zodParseOrThrow({
      schema: zToDiskGetCatalogFilesRequest,
      object: request,
