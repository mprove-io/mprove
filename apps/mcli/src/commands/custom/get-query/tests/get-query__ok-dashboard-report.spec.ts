...
let testId = 'mcli__get-query__ok-dashboard-report';
...
test('1', async t => {
  ...
  let commandLine = `get-query -p ${projectId} --repo dev --branch ${defaultBranch} \
--env prod --dashboard-id ec1_d1 --report-index 0 --get-sql`;
