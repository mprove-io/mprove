...
execSync('swc ../../libs/api-to-blockml/src -d dist/libs/api-to-blockml --source-maps --config-file .swcrc', { cwd: __dirname, stdio: 'inherit' });
...
const aliases = {
  '~blockml': resolve(__dirname, 'dist/src'),
  '~api-to-blockml': resolve(__dirname, 'dist/libs/api-to-blockml/src'),
