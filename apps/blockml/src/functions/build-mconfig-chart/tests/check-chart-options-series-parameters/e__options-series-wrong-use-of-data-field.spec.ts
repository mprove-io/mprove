...
let caller = CallerEnum.BuildReportCharts;
let func = FuncEnum.CheckChartOptionsSeriesParameters;
let testId = 'e__options-series-wrong-use-of-data-field';
...
test('1', async t => {
  ...
  t.is(errors[0].title, ErTitleEnum.OPTIONS_SERIES_WRONG_USE_OF_DATA_FIELD);
