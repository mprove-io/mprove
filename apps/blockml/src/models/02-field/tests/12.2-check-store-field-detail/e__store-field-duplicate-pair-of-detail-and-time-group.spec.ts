...
let testId = 'e__store-field-duplicate-pair-of-detail-and-time-group';
...
test('1', async t => {
  ...
  t.is(
    errors[0].title,
    common.ErTitleEnum.STORE_FIELD_DUPLICATE_PAIR_OF_DETAIL_AND_TIME_GROUP
  );
  t.is(errors[0].lines[0].line, 13);
  t.is(errors[0].lines[1].line, 18);
  t.is(errors[0].lines[2].line, 14);
  t.is(errors[0].lines[3].line, 19);
});
