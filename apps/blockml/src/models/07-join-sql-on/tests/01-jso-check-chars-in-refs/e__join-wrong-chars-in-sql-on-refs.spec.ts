...
let func = common.FuncEnum.JsoCheckCharsInRefs;
let testId = 'e__join-wrong-chars-in-sql-on-refs';
...
test('1', async t => {
  ...
  t.is(errors[0].title, common.ErTitleEnum.JOIN_WRONG_CHARS_IN_SQL_ON_REFS);
