...
let func = common.FuncEnum.SawCheckSingleRefs;
let testId = 'e__sql-always-where-refs-model-measure';
...
test('1', async t => {
  ...
  t.is(errors[0].title, common.ErTitleEnum.SQL_ALWAYS_WHERE_REFS_MODEL_MEASURE);
