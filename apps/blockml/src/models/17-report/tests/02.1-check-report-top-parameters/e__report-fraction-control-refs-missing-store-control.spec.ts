...
let testId = 'e__report-fraction-control-refs-missing-store-control';
...
test('1', async t => {
  ...
  t.is(
    errors[0].title,
    common.ErTitleEnum.FRACTION_CONTROL_REFS_MISSING_STORE_CONTROL
  );
  t.is(errors[0].lines[0].line, 9);
  t.is(errors[1].lines[0].line, 18);
});
