...
let func = common.FuncEnum.CheckReportRowUnknownParams;
let testId = 'e__unexpected-dictionary-in-parameters';
...
test('1', async t => {
  ...
  t.is(errors[0].title, common.ErTitleEnum.UNEXPECTED_DICTIONARY_IN_PARAMETERS);
