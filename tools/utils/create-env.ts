...
BACKEND_ENV=PROD
BACKEND_IS_DB_ENCRYPTION_ENABLED=TRUE
...
BACKEND_DEMO_PROJECT_DWH_MYSQL_HOST=dwh-mysql
BACKEND_DEMO_PROJECT_DWH_MYSQL_PORT=3306
BACKEND_DEMO_PROJECT_DWH_MYSQL_DATABASE=ecommerce
BACKEND_DEMO_PROJECT_DWH_MYSQL_USER=root
BACKEND_DEMO_PROJECT_DWH_MYSQL_PASSWORD=${dwhMysqlRootPass}
BACKEND_DEMO_PROJECT_DWH_TRINO_USER=trino
BACKEND_DEMO_PROJECT_DWH_TRINO_PASSWORD=
BACKEND_DEMO_PROJECT_DWH_PRESTO_USER=presto
